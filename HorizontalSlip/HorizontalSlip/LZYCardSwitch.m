...
#import "LZYCardSwitchFlowLayout.h"
#import "LZYCardCell.h"

@interface LZYCardSwitch ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)addCollectionView {
    ...
    LZYCardSwitchFlowLayout *flowLayout = [[LZYCardSwitchFlowLayout alloc] init];
    ...
    [self.collectionView registerClass:[LZYCardCell class] forCellWithReuseIdentifier:@"XLCardCell"];
...
#pragma mark -
#pragma mark Setter
- (void)setModels:(NSArray<LZYCardModel *> *)models {
    _models = models;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LZYCardCell* card = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
